...
def parse_args():
    ...
    parser.add_argument("-output_file_name", default="bias_corrected_fdc")
...
def main():
    ...
    bias_corrected_dict = bias_correction.FDC_bias_correction.bias_correction_all_time(input_ds, fdc_ds, start_year=1990, end_year=2000)
